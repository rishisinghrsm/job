...
<div class="container">
    <div class="row">
        <div class="col-md-9 mt-4 text-center m-auto">

        <h1>Contact Us !</h1>
    <h2 style="text-align: center;">Welcome to <span id="W_Name"> Bharat Job Finder</span>!</h2>
    ...
    <div style="text-align: center;">
      ...
      <p style="margin-left: 25%;"><i class="fas fa-envelope-open-text" style="color: #2c3e50; font-size: 20px;"></i> <b><i> <span id="W_Email"><a href="mailto:multilink.infotech@gmail.com">multilink.infotech@gmail.com</a></span></i></b><br>
