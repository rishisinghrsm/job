        ...
        <div class="col-md-9 m-auto">
            <div class="card " >
                <div class="card-header trirev  sticky-top ">
                    ...
                    <?php 
                    $id  = $_GET['cat'];
                    $cat = "SELECT * FROM category where catSNO = $id";
                    $catResult = mysqli_query($conn,$cat) or die("Failed To Fatch");
                    $data = mysqli_fetch_assoc($catResult);
                    ?>
                    <h2 class=" fw-bold m-0 text-uppercase text-white"><?php echo $data['category'] ?></h2>
                </div>
                <!-- catId3 = $id -->
                ...
                <div class="container  ">
                        <?php
                        $num = 1;
                        $sql1 = "SELECT * FROM `notification` WHERE status = 1 AND ( catId3 = $id )ORDER BY postDate DESC ";
