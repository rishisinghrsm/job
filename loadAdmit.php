            ...
            <div class="card " style="border: 4px solid green;">
                <div class="card-header  sticky-md-top  green ">
                    <ul class="nav nav-tabs   card-header-tabs fw-bolder">
                        <li class="nav-item ">
                            <a class="nav-link white " aria-current="true" href="index.php"  id="notification">LATEST NOTIFICATION
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link white active" href="loadAdmit.php" id="admit">ADMIT CARD</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link white" href="loadResult.php"  id="result">RESULT</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body  mt-0 p-0">
                    ...
                    <div class="container  ">
                        <?php
                        $num = 1;
                        $sql1 = "SELECT * FROM `notification` WHERE status = 1 AND admit = 1 ORDER BY  postDate AND updateDate DESC ";
                    ...
                    <p class="fs-5 text-uppercase text-end"><a href="loadAllAdmit.php" class="border border-4 border-success p-2 shadow bg-success text-white rounded-pill"> Show All ADmit card </a></p>
