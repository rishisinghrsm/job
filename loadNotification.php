            ...
            <div class="card " style="border: 4px solid green;">
                <div class="card-header  sticky-md-top  green ">
                    <ul class="nav nav-tabs   card-header-tabs fw-bolder">
                        <li class="nav-item ">
                            <a class="nav-link white " aria-current="true" href="allNotification.php"  id="notification">LATEST NOTIFICATION
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link white" href="loadNotification.php"   id="result">RESULT</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body  mt-0 p-0">
                    ...
                    <p class="fs-5 text-uppercase text-end"><a href="allNotification.php" class="border border-4 border-success p-2 shadow bg-success text-white rounded-pill"> Show All Notification </a></p>
