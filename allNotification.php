...
<div class="container-fluid mt-2 ">
    <div class="row">
        <div class="col-8 m-auto mb-1">
            <!-- <div class="search">
            <input type="search" class="form-control liveSearch " placeholder="SEARCH" >
        </div> -->
        </div>
            ...
            <div class="card " style="border: 4px solid green;">
                <div class="card-header  sticky-md-top  green ">
                    <ul class="nav nav-tabs   card-header-tabs fw-bolder">
                        <li class="nav-item ">
                            <a class="nav-link white active" aria-current="true" href="allnotification.php" id="allnotification">LATEST NOTIFICATION
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link white "  href="loadAllAdmit.php" id="alladmit">ADMIT CARD</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link white" href="loadAllResult.php" id="allresult">RESULT</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body  mt-0 p-0">
                    ...
                    <div class="container  ">
                        <?php
                        $num = 1;
                        $sql1 = "SELECT * FROM `notification` WHERE status = 1 ORDER BY postDate DESC ";
                            ...
                            <div class="row  shadow rounded-2 p-2  mb-1 " style="min-height: 80px;">
                                ...
                                <div class=" col-md-8 p-1 ">
                                    ...
                                    <div class=" row mt-1 p-0 d-flex align-items-start " style="font-size: 13px;font-family: 'Kanit', sans-serif;">
                                        ...
                                        <div class=" col-md-3 text-start p-1 grayText border-end border-black fw-bold  " style="font-size:14px;"><i class="bi bi-people"></i> &nbsp; Total Vacancy - <span class="text-">  <?php echo $row1['vacancy'] . " "; ?> </span></div>
