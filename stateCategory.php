...
<div class="container-fluid mt-5 ">
    <div class="row">
        <div class="col-md-9 m-auto" >
            <div class="card " >
                <div class="card-header trirev sticky-top ">
                  
                    <?php 
                    $id  = $_GET['stateId'];
                    $cat = "SELECT * FROM secondCategory where id = $id";
                    $catResult = mysqli_query($conn,$cat) or die("Failed To Fatch");
                    $data = mysqli_fetch_assoc($catResult);
                    ?>
                    <h2 class=" fw-bold m-0 text-uppercase text-white"><i class="bi bi-geo-alt"></i>&nbsp;<?php echo $data['secondCategory'] ?></h2>
                </div>
                ...
                <div class="container  ">
                        <?php
                        $num = 1;
                        $sql1 = "SELECT * FROM `notification` WHERE status = 1 AND ( catId2 = $id )ORDER BY postDate DESC ";
